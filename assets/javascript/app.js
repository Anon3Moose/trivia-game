$(document).ready(function() {
  ...
  function loadQuestion() {
    ...
    //There is a error within these variables take time aside to figure out issue
        //UPDATE hr1: after many trail and error there has been no success to finding out what is wrong.
        //UPDATE hr2: still no solution found
...
`); // found out that ' or " denote a string and ` denotes a 
    // template string. Template strings have some abilities that
    // normal strings do not. 
  }
